...
function directTurretDefenceCommand(numOfTurrets,numOfDetectedZombies){
    for (let shotssofar = 1; shotssofar<=numOfDetectedZombies; shotssofar++){
        console.log("Directing "+ numOfTurrets + " turrets fire to zombie #" + shotssofar)

    }
}

directTurretDefenceCommand(5,20)